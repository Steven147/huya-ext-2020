let app = new PIXI.Application({ antialias: true, width: 375, height: 600});
...
function introduction(){
  ...
  content_title = "虎牙小程序";
  content_total = "总起";
  content_emotion = "情感分析";
  content_classfy = "弹幕分类";
  content_statistics = "弹幕统计";

  let style_title = new PIXI.TextStyle({
    fontFamily: "Arial",
    fontSize: 36,
    fill: "white",
     dropShadow: true,
  ...
  const Text0 = new PIXI.Text(content_title, style_title);
  Text0.x = 110;
  Text0.y = 60;
  app.stage.addChild(Text0);

  const Text1 = new PIXI.Text(content_total, style);
  Text1.x = 50;
  Text1.y = 120;
  app.stage.addChild(Text1);

  const Text1_0 = new PIXI.Text(content_emotion, style);
  Text1_0.x = 50;
  Text1_0.y = 220;
  app.stage.addChild(Text1_0);
  
  const Text1_1 = new PIXI.Text(content_classfy, style);
  Text1_1.x = 50;
  Text1_1.y = 320;
  app.stage.addChild(Text1_1);
  
  const Text1_2 = new PIXI.Text(content_statistics, style);
  Text1_2.x = 50;
  Text1_2.y = 420;
  app.stage.addChild(Text1_2);
