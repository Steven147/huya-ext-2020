...
class Main {
    ...
    button(){
        ...
        var button1 = new PIXI.Sprite(PIXI.loader.resources["img/001.jpg"].texture);
        button1.buttonMode = true;
        button1.interactive = true;
        button1.position.set(0, -0.9);
        button1.scale.set(0.09,0.09);
        app.stage.addChild(button1);
        button1.on('pointerdown', () => this.onButtonDown1())
      
        var button2 = new PIXI.Sprite(PIXI.loader.resources["img/002.jpg"].texture);
        button2.buttonMode = true;
        button2.interactive = true;
        button2.position.set(73, 0);
        button2.scale.set(0.09,0.09);
        app.stage.addChild(button2);
        button2.on('pointerdown', () => this.onButtonDown2())
      
        var button4 = new PIXI.Sprite(PIXI.loader.resources["img/004.jpg"].texture);
        button4.buttonMode = true;
        button4.interactive = true;
        button4.position.set(292, 0);
        button4.scale.set(0.09,0.09);
        app.stage.addChild(button4);
        button4.on('pointerdown', () => this.onButtonDown4())

        var button5 = new PIXI.Sprite(PIXI.loader.resources["img/006.jpg"].texture);
        button5.buttonMode = true;
        button5.interactive = true;
        button5.position.set(219, 0);
        button5.scale.set(0.09,0.09);
    ...
    button_statis(){
        ...
        var button3 = new PIXI.Sprite(PIXI.loader.resources["img/003.jpg"].texture);
        button3.buttonMode = true;
        button3.interactive = true;
        button3.position.set(146, 0);
        button3.scale.set(0.09,0.09);
    ...
    introduction(){
        const { app } = this;
        var logo = new PIXI.Sprite(PIXI.loader.resources["img/bg.jpg"].texture);
        logo.buttonMode = true;
        logo.interactive = true;
        logo.position.set(-2, 41);
        logo.scale.set(0.191,0.191);
